...
// -------------------------------------------------------------------------
// test if mutex waiting thread queue is empty

cyg_bool Cyg_Mutex::queue_empty()
{
    CYG_REPORT_FUNCTION();
...
// -------------------------------------------------------------------------
// return first thread on mutex waiting thread queue 

char* Cyg_Mutex::queue_highpri_thread_name()
{
    CYG_REPORT_FUNCTION();
