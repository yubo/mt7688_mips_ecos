		...
		if (isAdd)
		{
			...
			switch (tid)
			{
				case 0:
					...
					wtbl_2->wtbl_2_d2.field.tid_ac_0_sn = sn;
					HW_IO_WRITE32(pAd, reg, wtbl_2->wtbl_2_d2.word);
					break;
				case 1:
					reg = ent.wtbl_addr[1] + (4 * 2); //WTBL2.DW2
					HW_IO_READ32(pAd, reg, &wtbl_2->wtbl_2_d2.word);
					wtbl_2->wtbl_2_d2.field.tid_ac_1_sn = sn;
					HW_IO_WRITE32(pAd, reg, wtbl_2->wtbl_2_d2.word);
					break;
				case 2:
					reg = ent.wtbl_addr[1] + (4 * 2); //WTBL2.DW2
					HW_IO_READ32(pAd, reg, &wtbl_2->wtbl_2_d2.word);
					wtbl_2->wtbl_2_d2.field.tid_ac_2_sn_0 = (sn & 0xff);
					HW_IO_WRITE32(pAd, reg, wtbl_2->wtbl_2_d2.word);

        			reg = ent.wtbl_addr[1] + (4 * 3); //WTBL2.DW3
					HW_IO_READ32(pAd, reg, &wtbl_2->wtbl_2_d3.word);
					wtbl_2->wtbl_2_d3.field.tid_ac_2_sn_9 = ((sn & (0xf << 8)) >> 8);
					HW_IO_WRITE32(pAd, reg, wtbl_2->wtbl_2_d3.word);
					break;
				case 3:
        			reg = ent.wtbl_addr[1] + (4 * 3); //WTBL2.DW3
					HW_IO_READ32(pAd, reg, &wtbl_2->wtbl_2_d3.word);
					wtbl_2->wtbl_2_d3.field.tid_ac_3_sn = sn;
					HW_IO_WRITE32(pAd, reg, wtbl_2->wtbl_2_d3.word);
					break;
				case 4:
        			reg = ent.wtbl_addr[1] + (4 * 3); //WTBL2.DW3
					HW_IO_READ32(pAd, reg, &wtbl_2->wtbl_2_d3.word);
					wtbl_2->wtbl_2_d3.field.tid_4_sn = sn;
					HW_IO_WRITE32(pAd, reg, wtbl_2->wtbl_2_d3.word);
					break;
				case 5:
        			reg = ent.wtbl_addr[1] + (4 * 3); //WTBL2.DW3
					HW_IO_READ32(pAd, reg, &wtbl_2->wtbl_2_d3.word);
					wtbl_2->wtbl_2_d3.field.tid_5_sn_0 = (sn & 0xf);
					HW_IO_WRITE32(pAd, reg, wtbl_2->wtbl_2_d3.word);

					reg = ent.wtbl_addr[1] + (4 * 4); //WTBL2.DW4
					HW_IO_READ32(pAd, reg, &wtbl_2->wtbl_2_d4.word);
					wtbl_2->wtbl_2_d4.field.tid_5_sn_5 = ((sn & (0xff << 4)) >> 4);
					HW_IO_WRITE32(pAd, reg, wtbl_2->wtbl_2_d4.word);
					break;
				case 6:
					reg = ent.wtbl_addr[1] + (4 * 4); //WTBL2.DW4
					HW_IO_READ32(pAd, reg, &wtbl_2->wtbl_2_d4.word);
					wtbl_2->wtbl_2_d4.field.tid_6_sn = sn;
					HW_IO_WRITE32(pAd, reg, wtbl_2->wtbl_2_d4.word);
					break;
				case 7:
					reg = ent.wtbl_addr[1] + (4 * 4); //WTBL2.DW4
					HW_IO_READ32(pAd, reg, &wtbl_2->wtbl_2_d4.word);
					wtbl_2->wtbl_2_d4.field.tid_7_sn = sn;
					HW_IO_WRITE32(pAd, reg, wtbl_2->wtbl_2_d4.word);
					break;
				default:
...
INT MtAsicStartContinousTx(RTMP_ADAPTER *pAd, UINT32 PhyMode, UINT32 BW, UINT32 PriCh, UINT32 Mcs, UINT32 WFSel)
{
	...
	/* Band Edge */
	pwr_dbm = (((INT32)tx_pwr) >> 24) & 0x7f;
	PHY_IO_READ32(pAd, CR_PHYMUX_24, &reg); /* 0x4260 */
	gc_thresh = (INT32)reg;
	pa_mode = (gc_thresh>>24) &0x7f; /* Half PA[30:24] */
	if(pwr_dbm >= pa_mode){
		gc = 0x1;
	}else{
		gc = 0x0;
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_OFF,("%s(): gc[0x0204]: 0x%x\n",__FUNCTION__, gc));
	/* End of GC Swap */
