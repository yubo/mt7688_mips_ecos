...
typedef struct GNU_PACKED _FRAME_TMR_UNPROTECTED_ACTION {
    HEADER_802_11   Hdr;
    UCHAR   Category;
    UCHAR   Action;
    UCHAR   DialogToken;
    UCHAR   FollowUpDialogToken;
    UINT32  TOD;/*Unit 10ns */
    UINT32  TOA;/*Unit 10ns */
    UCHAR   MaxTodErr;
    UCHAR   MaxToaErr;
}   FRAME_TMR_UNPROTECTED_ACTION, *PFRAME_TMR_UNPROTECTED_ACTION;
