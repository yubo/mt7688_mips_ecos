...
#define MON_CMD_TRAFFIC_INIT	((MON_CMD_INIT&0xff)|MOD_TRAFFIC)
...
#define MON_CMD_TRAFFIC_UPDATE	((MON_CMD_UPDATE&0xff)|MOD_TRAFFIC)
...
#define MON_CMD_TRAFFIC_STOP	((MON_CMD_STOP&0xff)|MOD_TRAFFIC)
